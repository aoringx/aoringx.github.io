...
const labelsFirst = ["Python", "NLP Research", "Gemini", "Hugging Face"];
    ...
    <div className="container" id="about">
      <div className="skills-container">
        ...
        <p className="about">
          ...
          majoring in Computer Science at the University of Michigan. <br></br>
          My research interest is in Machine Learning and Natural Language
          Processing, and I currently serve as a research assistant at the
          LAUNCH Lab. I am also passionate about embedded systems and computer
          security. <br></br>I am fluent in C++ and Python, and proficient in
        ...
        <div className="skills-grid">
          ...
          <div className="skill">
            ...
            <p>
              ...
              and frameworks including React and Flask. I also have experience
              with incorporating LLM responses, video conferencing, secure data
              storage and geospatial mapping, etc.
            </p>
            <div className="flex-chips">
              <span className="chip-title">Tech stack:</span>
